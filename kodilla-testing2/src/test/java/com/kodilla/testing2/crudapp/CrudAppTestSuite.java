...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://krzysiekblaszczyk.github.io";
    ...
    private String createCrudAppTestTask() throws InterruptedException {
        final String XPATH_TASK_NAME = "//html/body/main/section/form/fieldset/input";
        final String XPATH_TASK_CONTENT = "//html/body/main/section/form/fieldset[2]/textarea";
